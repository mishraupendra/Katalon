...
Thread.sleep(7000)
 ...
 sdom_js4 = 'return document.querySelector("#root_pagemashupcontainer-2_mashupcontainer-308_mashupcontainer-117_ptcschartbar-140").shadowRoot.querySelector("#xaxis").shadowRoot.querySelector("#ticks > ptcs-label:nth-child(10)").shadowRoot.querySelector("#label")'
 ...
 //Site == MDP
 //Previous Year Data
 sdom_js4 = 'return document.querySelector("#root_pagemashupcontainer-2_mashupcontainer-308_mashupcontainer-117_ptcschartbar-140").shadowRoot.querySelector("#chart").shadowRoot.querySelector("#bars > div:nth-child(10) > ptcs-div:nth-child(1) > div > div")'
 ...
 ////Current Year Data
 sdom_js4 = 'return document.querySelector("#root_pagemashupcontainer-2_mashupcontainer-308_mashupcontainer-117_ptcschartbar-140").shadowRoot.querySelector("#chart").shadowRoot.querySelector("#bars > div:nth-child(10) > ptcs-div:nth-child(2) > div > div")'
 ...
 if(GOA_CY==0 && GOA_PY == 0 )
	 println("GOA Site is not applicable for Accidents")
 
	 
 double Color_coding_Accident_AC=((GOA_CY - GOA_PY)/GOA_PY)*100
...
// ////Current Year Data
 ...
 {
	 println("MDP is not applicable for Incidents")
 }

 float Color_coding_Incident_GOA=((GOA_CY_Incidents - GOA_PY_Incidents)/GOA_PY_Incidents)*100
 ...
 //typecasting
 int ANK_PY_NearMiss=Integer.parseInt(text1);
 ...
 int ANK_CY_NearMiss=Integer.parseInt(text2);
 
 
 if(ANK_PY_NearMiss==0 && ANK_CY_NearMiss==0)
 {
	 println("GOA is not applicable for Near Misses")
 }
 
	 
 float Color_coding_NearMiss=((ANK_CY_NearMiss - ANK_PY_NearMiss)/ANK_PY_NearMiss)*100
...
//	 //typecasting
 int ANK_PY_TH=Integer.parseInt(text1);
...
//	 
 ...
 int ANK_CY_TH=Integer.parseInt(text2);
 
 
 if(ANK_PY_TH==0 && ANK_CY_TH==0)
 {
	 println("GOA is not applicable for Training Hours & Man Hours Worked")
 }

	 
 float Color_coding_TH=((ANK_CY_TH - ANK_PY_TH)/ANK_PY_TH)*100
...
{
	//MDP Tab
	sdom_js6 = 'document.querySelector("#root_pagemashupcontainer-2_ptcsdropdown-312").shadowRoot.querySelector("#select > ptcs-list-item > ptcs-div").click()'
	
	Near_miss = WebUI.executeJavaScript(sdom_js6, null)
	
	Thread.sleep(7000)
	
	sdom_js6='document.querySelector("#root_pagemashupcontainer-2_ptcsdropdown-312-external-wc").shadowRoot.querySelector("#chunker > div > div > ptcs-list-item:nth-child(10) > ptcs-div > ptcs-label").shadowRoot.querySelector("#label").click()'
	Near_miss = WebUI.executeJavaScript(sdom_js6, null)
...
println(Total_Accidents.getText())
text10P=Total_Accidents.getText()
...
println(Total_Accidents.getText())
text11C=Total_Accidents.getText()
...
println(Total_Incidents.getText())
text13P=Total_Incidents.getText()
...
println(Total_Incidents.getText())
text14C=Total_Incidents.getText()
...
//Site == MDP
	...
	if(Color_coding_Accident_AC==text9)
		println("For MDP Site -(Function >>EHS Tab>>Safety Data) and (Site Tab >>EHS>>Safety Data) VAR VS PY(%) Calculation is Correct !!")
	else
