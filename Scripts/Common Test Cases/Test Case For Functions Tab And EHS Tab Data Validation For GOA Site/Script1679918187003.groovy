...
Thread.sleep(7000)
 ...
 sdom_js4 = 'return document.querySelector("#root_pagemashupcontainer-2_mashupcontainer-308_mashupcontainer-117_ptcschartbar-140").shadowRoot.querySelector("#xaxis").shadowRoot.querySelector("#ticks > ptcs-label:nth-child(6)").shadowRoot.querySelector("#label")'
 ...
 //Site == GOA
 //Previous Year Data
 sdom_js4 = 'return document.querySelector("#root_pagemashupcontainer-2_mashupcontainer-308_mashupcontainer-117_ptcschartbar-140").shadowRoot.querySelector("#chart").shadowRoot.querySelector("#bars > div:nth-child(6) > ptcs-div:nth-child(1) > div > div")'
 ...
 ////Current Year Data
 sdom_js4 = 'return document.querySelector("#root_pagemashupcontainer-2_mashupcontainer-308_mashupcontainer-117_ptcschartbar-140").shadowRoot.querySelector("#chart").shadowRoot.querySelector("#bars > div:nth-child(6) > ptcs-div:nth-child(2) > div > div")'
 ...
 if(GOA_CY==0 && GOA_PY == 0 )
    ...
    {
		 Color_coding_Accident_GOA = Math.round(GOA_CY * 100)
		 println(Color_coding_Accident_GOA)
    } 
 else
    {
		 Color_coding_Accident_GOA=Math.round(((GOA_CY - GOA_PY)/GOA_PY)*100)
...
if(Site=="GOA")
{
	...
	sdom_js6='document.querySelector("#root_pagemashupcontainer-2_ptcsdropdown-312-external-wc").shadowRoot.querySelector("#chunker > div > div > ptcs-list-item:nth-child(5) > ptcs-div > ptcs-label").shadowRoot.querySelector("#label").click()'
	Near_miss = WebUI.executeJavaScript(sdom_js6, null)
...
//println(text19P)
//text19P=NumberFormat.getNumberInstance(java.util.Locale.US).parse(Integer.parseInt(Near_miss.getText()))
...
////Site == GOA
	...
	//Accidents 
	if(Color_coding_Accident_GOA == text9 )
